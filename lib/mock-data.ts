...
export const CONTENIDO: Contenido[] = [
  ...
  { id: 'c2', titulo: 'Estudio 1: ¿Qué es el evangelio?',                 descripcion: 'Qué es el evangelio, por qué importa y cómo cambia todo.',                  categoria: 'material-base', tipo: 'pdf', semana: 1, modulo: 'fundamento', url: '/contenido/fundamento/Estudio 1 - ¿Qué es el evangelio?.pdf',                   fecha: '2026-01-13' },
