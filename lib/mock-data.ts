...
export const CONTENIDO: Contenido[] = [
  ...
  { id: 'c6', titulo: 'Estudio 5: ¿Y ahora qué? Viviendo desde el Evangelio', descripcion: 'Cómo vivir el evangelio en el día a día una vez que lo hemos recibido.',  categoria: 'material-base', tipo: 'pdf', semana: 5, modulo: 'formacion', url: '/contenido/fundamento/estudio-5-viviendo-desde-el-evangelio.pdf', fecha: '2026-02-10' },
  { id: 'c7', titulo: 'Estudio 6: Viviendo desde el Evangelio',              descripcion: 'Profundizando en cómo el evangelio transforma nuestra vida diaria.',       categoria: 'material-base', tipo: 'pdf', semana: 6, modulo: 'formacion', url: '/contenido/fundamento/estudio-6-viviendo-desde-el-evangelio.pdf',  fecha: '2026-02-17' },
  { id: 'c8', titulo: 'Estudio 7: Perdón de pecados',                       descripcion: 'El perdón como base del evangelio y su impacto en nuestra vida.',            categoria: 'material-base', tipo: 'pdf', semana: 7, modulo: 'formacion', url: '/contenido/fundamento/estudio-7-perdon-de-pecados.pdf',           fecha: '2026-03-09' },
  ...
  { id: 'c13', titulo: 'Estudio 12: Nuevo Nacimiento',  descripcion: 'Qué significa nacer de nuevo y cómo esa realidad define nuestra vida en Cristo.',       categoria: 'material-base', tipo: 'pdf', semana: 12, modulo: 'formacion', url: '/contenido/fundamento/estudio-12-nuevo-nacimiento.pdf',  fecha: '2026-04-20' },
  { id: 'c14', titulo: 'Estudio 13: Unión con Cristo',  descripcion: 'Lo que significa estar unidos a Cristo y cómo esa unión lo cambia todo en nuestra vida.',  categoria: 'material-base', tipo: 'pdf', semana: 13, modulo: 'formacion', url: '/contenido/fundamento/estudio-13-union-con-cristo.pdf',  fecha: '2026-05-04' },
  { id: 'c15', titulo: 'Estudio 14: Santificación',    descripcion: 'Qué es la santificación, cómo ocurre y por qué es inseparable del evangelio que creemos.', categoria: 'material-base', tipo: 'pdf', semana: 14, modulo: 'formacion', url: '/contenido/fundamento/estudio-14-santificacion.pdf',    fecha: '2026-05-11' },
